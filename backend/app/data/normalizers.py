...
def normalize_stock_fundamental(
    ...
    * ``BaostockProvider`` produces daily snapshots (each K-line row carries
    ...
    return StockFundamental(
        ...
        roe=parse_decimal(first_value(row, "roe", "ROE", "roeAvg", "净资产收益率")),
        ...
        net_profit=parse_decimal(first_value(row, "net_profit", "netProfit", "归母净利润", "净利润")),
        ...
        gross_margin=parse_decimal(first_value(row, "gross_margin", "gpMargin", "销售毛利率")),
